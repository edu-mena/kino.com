...
{
    public function show(Request $request, Restaurant $restaurant, string $customerKey): JsonResponse
    {
    ...
    public function update(Request $request, Restaurant $restaurant, string $customerKey): JsonResponse
    {
        $this->authorize('manageOperations', $restaurant);
